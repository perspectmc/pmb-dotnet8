...
def process_file(file_path: Path) -> List[Dict[str, Any]]:
    ...
    try:
        ...
        for i, chunk in enumerate(chunks):
            ...
            # ✅ June 10, 2025 @ 2:10 PM — added doc_category inline for better context-based semantic search
            category = metadata.get("doc_category", "").strip()
            label = f"[{rel_path}]"
            if category:
            ...
            # ✅ June 10, 2025 @ 2:50 PM — added keyword metadata for filtered semantic search
            import re
